  ...
  return (
    <ScrollView style={{backgroundColor: COLORS.white2}}>
      <Block gap={14.8} radius={8}>
        <Pressable
          onPress={() => commonRoot.navigate(router.DETAIL_DOING_JOB)}
          ...
          <Block marginTop={12} borderWidth={1} borderColor={COLORS.gray11} />
          <Block height={42} marginTop={12} row gap={10} spaceBetween>
            <Block>
              <Text fontSize={13} regular color={COLORS.placeholder}>
                Thời gian đến
              </Text>
              <Text marginTop={6} fontSize={15} medium color={COLORS.red4}>
                08:30
              </Text>
            </Block>
            <Block
